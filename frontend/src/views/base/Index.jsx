                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 mb-6 mb-lg-0">
                            <div>
                                ...
                                <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" className="btn btn-outline-success fs-4 text-inherit ms-3">
                        ...
                        <div className="col-lg-6 d-flex justify-content-center">
                            ...
                            <div className="position-relative">
                                <img src="https://img.freepik.com/free-photo/front-view-young-female-student-red-shirt-black-bag-holding-copybooks-files-smiling-writing-down-white_140725-16616.jpg?t=st=1732583764~exp=1732587364~hmac=89c9d0dd47cdf9547ba8a6ee683d164b0bfe33e49249dd3168db68127cbcb0df&w=996" alt="girl" className="end-0 bottom-0" />
                            </div>
                        </div>
                    </div>
                </div>
