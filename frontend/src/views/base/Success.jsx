          ...
          <div className="row g-5 align-items-center justify-content-center">
            ...
            {orderMessage === "Payment Successfull" && (
              <>
                <div className="col-lg-5">
                  ...
                  <p>
                    {" "}
                    Hey there, you enrollment in the course where successful,
                ...
                <div className="col-lg-7 text-center">
                  <img
                    src="https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExMmFqdzZsdnFkemhrbDVnZzlvZDl6ajh2M3h6aXdzbW41a2xtZzB3aiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/4xpB3eE00FfBm/giphy.gif"
            ...
            {orderMessage === "Already Paid" && (
              <>
                ...
                <div className="col-lg-7 text-center">
                  <img
                    src="https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExbzNubWsxaGtxNm0ybTRxbDIzdDRzMnpjOXZscGp3YTJqeXVrcnY0cCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/3orif6l1gdb0dkvjva/giphy.gif"
                    className="h-300px h-sm-400px h-md-500px h-xl-700px"
                    alt=""
                  />
                </div>
