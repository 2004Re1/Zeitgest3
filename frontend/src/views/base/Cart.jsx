                        ...
                        <div className="row g-4 g-sm-5">
                            ...
                            <div className="col-lg-8 mb-4 mb-sm-0">
                                <div className="p-4 shadow rounded-3">
                                    <h5 className="mb-0 mb-3">Card Items ({cart?.length})</h5>
                                            ...
                                            <tbody className="border-top-2">
                                                {cart?.map((c, index) => (
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button onClick={() => cartItemDelete(c.id)} className="btn btn-sm btn-danger px-2 mb-0" type="button">
                                                ...
                                                {cart?.length < 1 && <p className="mt-1 p-1">No Item In Card</p>}
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-4">
                                <div className="p-4 shadow rounded-3">
                                    <h4 className="mb-3">Card Total</h4>
