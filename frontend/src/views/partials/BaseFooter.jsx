                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6 col-12 text-white">
                        ...
                        <div className="mb-4">
                            <h1>Zeitgeist</h1>
                            <div className="mt-4">
                                <p>Zeitgeist is feature-rich components and beautifully Bootstrap UIKit for developers, built with bootstrap responsive framework.</p>
                                {/* social media */}
